...
<script type="application/javascript">
	console.log('commonTemplate import');
</script>
...
<!-- Sweet Alert -->
<!--
<link type="text/css" href="./vendor/volt-v1.4.1/vendor/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet">
-->

<!-- Notyf -->
<!--
<link type="text/css" href="./vendor/volt-v1.4.1/vendor/notyf/notyf.min.css" rel="stylesheet">
-->
